...
def extend_cfg(cfg):
    ...
    cfg.TRAINER.TCP.FUSION = True
    cfg.TRAINER.TCP.FUSION_ALPHA = 0.5
    cfg.TRAINER.COMPETITIVE_VISUAL_PROMPT = CN()
    cfg.TRAINER.COMPETITIVE_VISUAL_PROMPT.ENABLED = True
    cfg.TRAINER.COMPETITIVE_VISUAL_PROMPT.INSERT_LAYER = 8
    cfg.TRAINER.COMPETITIVE_VISUAL_PROMPT.NUM_TOKENS = 4
    cfg.TRAINER.COMPETITIVE_VISUAL_PROMPT.BOTTLENECK_DIM = 128
    cfg.TRAINER.COMPETITIVE_VISUAL_PROMPT.SERIAL = True
    cfg.TRAINER.COMPETITIVE_VISUAL_PROMPT.FUSION = True
    cfg.TRAINER.COMPETITIVE_VISUAL_PROMPT.FUSION_ALPHA = 0.5
